# Generated by Powerlevel10k configuration wizard on 2023-04-28 at 17:28 PDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kns|kubectl|helm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|flux|fluxctl|stern|kubeseal|skaffold|kubent|kubecolor'
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_CLASSES=(
      '*primary-preprod*'    PREPROD
      '*primary-staging*'    STAGING
      '*primary-production*' PROD)
  typeset -g POWERLEVEL9K_KUBECONTEXT_PREPROD_FOREGROUND=34
  typeset -g POWERLEVEL9K_KUBECONTEXT_PREPROD_VISUAL_IDENTIFIER_EXPANSION=''
  typeset -g POWERLEVEL9K_KUBECONTEXT_STAGING_FOREGROUND=134
  ...
  POWERLEVEL9K_KUBECONTEXT_PREPROD_CONTENT_EXPANSION+='${${:-/$P9K_KUBECONTEXT_NAMESPACE}:#/default}'
  typeset -g POWERLEVEL9K_KUBECONTEXT_STAGING_CONTENT_EXPANSION='staging'
  # Append the current context's namespace if it's not "default".
  POWERLEVEL9K_KUBECONTEXT_STAGING_CONTENT_EXPANSION+='${${:-/$P9K_KUBECONTEXT_NAMESPACE}:#/default}'
